...
import com.zeron.sophon.test.command.TestClassRunCmd;
import com.zeron.sophon.test.command.TestMethodRunCmd;
...
public class TestExecutor {
    ...
    private void runMethodTest(TestMethodRunCmd cmd, Class<?> testClz, Object testInstance) throws Exception{
        ...
        //notifier.fireTestStarted(method, sophonDes.getDescription());

        //invoke test method
        invokeMethod(testInstance, method);
        //notifier.fireTestFinished(method, sophonDes.getDescription());

        //invoke after method
        invokeMethod(testInstance, afterMethod);
        //notifier.fireTestRunFinished(sophonDes.getDescription());
    }

...
import com.zeron.sophon.test.command.AbstractCommand;
import com.zeron.sophon.test.command.GuideCmd;
 ...
 *   例如：com.zeron.framework.pdm.service.test.CustomerServiceTest.testCheckConflict()
 * 2.测试整个测试类，请在控制台输入类全称
 *   例如：com.zeron.framework.pdm.service.test.CustomerServiceTest

...
public class GuideCmd extends AbstractCommand {
    ...
    protected void action() {
        if(cmdRaw.equals(GUIDE_HELP)){
            ...
            System.out.println("**** 例如：com.zeron.framework.pdm.service.test.CustomerServiceTest.testCheckConflict()");
            System.out.println("**** 2.测试整个测试类，请在控制台输入类全称");
            System.out.println("**** 例如：com.zeron.framework.pdm.service.test.CustomerServiceTest");
            System.out.println("**** 3.重复上一次测试，只需在控制台输入字母 - ‘r’");
            System.out.println("**** 4.自动生成sophonTest测试类,请输入‘new 方法全称  参数1 参数2 ...’");
            System.out.println("**** 例如：new com.zeron.framework.pdm.domain.customer.entity.CustomerE#addContact");
            System.out.println("***********************************************************************************");
